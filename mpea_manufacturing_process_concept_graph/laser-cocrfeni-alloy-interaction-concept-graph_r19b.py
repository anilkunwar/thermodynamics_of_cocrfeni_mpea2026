...
# ============================================================================
BATCH_TEXT_STORE_CAP = 4000  # Max chars of text to store per document
...
# ============================================================================
# INCREMENTAL GRAPH BUILDER (for batch processing)
# ============================================================================
class IncrementalGraphBuilder(ReasoningEnhancedGraphBuilder):
    """
    Builds a graph from a single document batch.
    Node frequencies come from the batch itself so that merge_graphs()
    can accumulate them correctly across batches.
    """
    ...
    def build_batch_graph(
        ...
        # Add nodes with batch frequencies
        for c in valid_concepts:
            concept_type = self.ontology.get_concept_type(c)
            definition = self.ontology.get_definition(c)
            nx_graph.add_node(
        ...
        # Co-occurrence edges within the batch
        cooccurrence_map: Dict[Tuple[str, str], int] = defaultdict(int)
...
# ============================================================================
# MEMORY & METRICS UTILITIES (Batch Processing)
# ============================================================================
...
# ============================================================================
# GRAPH MERGING & WEIGHT RECOMPUTATION (Batch Processing)
# ============================================================================
    ...
    for node, data in new_graph.nodes(data=True):
        if node in merged:
            merged.nodes[node]["frequency"] = (
                merged.nodes[node].get("frequency", 0) + data.get("frequency", 0)
            )
