...
# -*- coding: utf-8 -*-
"""
HEA-Laser-ConceptGraph: Concept Graph Builder for CoCrFeNi Laser AM Process-Material Response
============================================================================================
...
- HEA-Laser AM domain filtering (CoCrFeNi, LPBF, TDT/CPD, phase-field, Marangoni, AI surrogates)
...
# ==========================================
st.set_page_config(
    page_title="HEA-Laser-ConceptGraph: CoCrFeNi Laser AM Process-Material Response Explorer",
    page_icon="🔬",
    layout="wide",
...
# ==========================================
def main():
    st.title("HEA-Laser-ConceptGraph: CoCrFeNi Laser AM Process-Material Response Explorer")
    st.caption("Large-corpus concept graph builder for CoCrFeNi laser AM | Optimized for alloy names, laser processing parameters, materials response and thermophysical phenomena")
    render_sidebar()
