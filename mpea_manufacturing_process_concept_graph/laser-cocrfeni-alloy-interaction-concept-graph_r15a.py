...
def run_batch_analysis(
    ...
    def _process_one_batch(batch_num: int) -> None:
        ...
        # REMOVED: batch_valid = batch_valid[:top_n]
        # Let the graph grow naturally, global capping happens in _finalize()
    ...
    def _finalize() -> None:
        ...
        # Re-seed before GNN training so results are identical every run
        np.random.seed(42)
        torch.manual_seed(42)
