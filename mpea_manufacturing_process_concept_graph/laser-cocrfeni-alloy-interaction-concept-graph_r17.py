...
# -*- coding: utf-8 -*-
"""
HEA-Laser-ConceptGraph v6.2 (Memory-Safe + OOM Fix + Lazy Analytics)
==============================================================================
...
# ============================================================================
st.set_page_config(
    page_title="HEA-Laser-ConceptGraph v6.2: Memory-Safe Batch Mode + OOM Fix",
    page_icon="🔬",
    layout="wide",
...
def run_batch_analysis(
    ...
    if initial_mem > 400:
        st.warning(
            f"⚠️ High memory usage already at {initial_mem:.0f} MB BEFORE "
            f"starting. Consider reducing batch size in sidebar or "
            f"clicking 🗑️ Reset batch state before starting."
        )
