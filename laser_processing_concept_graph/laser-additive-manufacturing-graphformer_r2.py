...
# -*- coding: utf-8 -*-
"""
Laser Additive Manufacturing (LAM) Concept Graph v1.0
=====================================================
Multi-level reasoning concept graph for laser additive manufacturing.
Focus: Process–Structure–Property relationships, defect mitigation,
material development, and process optimisation.

This is a domain-adapted version of the thermoelectric concept graph,
...
replaced with those for laser additive manufacturing.

NEW: Integration of a VAE‑regressor for property prediction (placeholder).
...
Run:
    streamlit run lam_concept_graph_v1.0.py
...
# ============================================================================
# RUNTIME COMPUTATIONAL METRICS LOGGER (unchanged)
# ============================================================================
...
# ============================================================================
# RUNTIME METRICS PANEL (live) + DASHBOARD (post-run) - UNCHANGED
# ============================================================================
...
# ============================================================================
st.set_page_config(
    page_title="Laser Additive Manufacturing Concept Graph v1.0",
    page_icon="🔬",
    layout="wide",
...
# ============================================================================
# ENHANCED ONTOLOGY & NLP REASONING SYSTEM (LASER ADDITIVE MANUFACTURING)
# ============================================================================
...
class DomainOntology:
    """Comprehensive ontology for Laser Additive Manufacturing."""
    ...
    def _build_ontology(self) -> None:
        # ============================================================================
        # --- Materials ---
        self._add_concept("ti_6al_4v", ConceptType.MATERIAL,
            synonyms={"ti6al4v", "ti-6al-4v", "ti64", "titanium alloy", "grade 5"},
            definition="Ti-6Al-4V – the most widely used titanium alloy in additive manufacturing, known for high strength-to-weight ratio.")
        self._add_concept("inconel_718", ConceptType.MATERIAL,
            synonyms={"in718", "inconel 718", "alloy 718", "ni-based superalloy 718"},
            definition="Inconel 718 – a precipitation-hardenable nickel-chromium superalloy used in high-temperature aerospace applications.")
        self._add_concept("aisi_316l", ConceptType.MATERIAL,
            synonyms={"316l", "316l ss", "stainless steel 316l", "a316l"},
            definition="AISI 316L – austenitic stainless steel, commonly used in LPBF for corrosion resistance and mechanical properties.")
        self._add_concept("alsi10mg", ConceptType.MATERIAL,
            synonyms={"al-si10mg", "alsi10mg", "aluminium alloy", "alsi10mg alloy"},
            definition="AlSi10Mg – aluminium-silicon-magnesium alloy, widely used in LPBF for lightweight structural parts.")
        self._add_concept("hastelloy_x", ConceptType.MATERIAL,
            synonyms={"hastelloy x", "hx", "ni-based superalloy hx"},
            definition="Hastelloy X – a nickel-based superalloy with excellent oxidation resistance and high-temperature strength.")
        self._add_concept("cu_crzr", ConceptType.MATERIAL,
            synonyms={"cucrzr", "copper-chromium-zirconium", "cu-cr-zr"},
            definition="CuCrZr – a copper alloy with high thermal and electrical conductivity, used for heat exchangers and moulds.")
        self._add_concept("m50nil", ConceptType.MATERIAL,
            synonyms={"m50nil", "bearing steel", "m50 nil"},
            definition="M50NiL – a high‑strength bearing steel, used in aerospace and automotive applications.")
        self._add_concept("ti_5553", ConceptType.MATERIAL,
            synonyms={"ti-5553", "ti5553", "titanium alloy ti-5553"},
            definition="Ti-5553 – a metastable beta titanium alloy with high strength and toughness, used in aerospace structural parts.")
        self._add_concept("inconel_625", ConceptType.MATERIAL,
            synonyms={"in625", "inconel 625", "alloy 625"},
            definition="Inconel 625 – a nickel-based superalloy with excellent corrosion resistance and weldability.")
        self._add_concept("cm247lc", ConceptType.MATERIAL,
            synonyms={"cm247lc", "ni-based superalloy cm247lc"},
            definition="CM247LC – a nickel-based superalloy with high creep resistance, used in turbine blade applications.")
        self._add_concept("ni_20zr", ConceptType.MATERIAL,
            synonyms={"ni-20zr", "nickel-zirconium"},
            definition="Ni-20Zr – a binary nickel alloy used in additive manufacturing research.")
        self._add_concept("ni_5al", ConceptType.MATERIAL,
            synonyms={"ni-5al", "nickel-aluminium"},
            definition="Ni-5Al – a binary nickel‑aluminium alloy for studying precipitation hardening.")
        self._add_concept("ni_5nb", ConceptType.MATERIAL,
            synonyms={"ni-5nb", "nickel-niobium"},
            definition="Ni-5Nb – a binary nickel‑niobium alloy used in additive manufacturing printability studies.")
        self._add_concept("co_cr_mo", ConceptType.MATERIAL,
            synonyms={"co-cr-mo", "cobalt-chromium-molybdenum", "stellite"},
            definition="Co-Cr-Mo – a cobalt-based superalloy used for biomedical implants and wear‑resistant coatings.")
        self._add_concept("pure_cu", ConceptType.MATERIAL,
            synonyms={"copper", "cu", "pure copper"},
            definition="Pure copper – used in LPBF for thermal management and electrical applications.")
        self._add_concept("tungsten", ConceptType.MATERIAL,
            synonyms={"w", "tungsten", "pure tungsten"},
            definition="Tungsten – a refractory metal with very high melting point, used in high‑temperature applications and anti‑scattering grids.")
        self._add_concept("molybdenum", ConceptType.MATERIAL,
            synonyms={"mo", "molybdenum", "pure molybdenum"},
            definition="Molybdenum – a refractory metal, used in high‑temperature and nuclear applications.")
        self._add_concept("ta", ConceptType.MATERIAL,
            synonyms={"tantalum", "ta", "pure tantalum"},
            definition="Tantalum – a refractory metal with excellent corrosion resistance, used in biomedical implants.")
        self._add_concept("h13_tool_steel", ConceptType.MATERIAL,
            synonyms={"h13", "h13 tool steel", "aisi h13"},
            definition="H13 – a hot‑work tool steel used in die‑casting and injection moulding applications.")
        self._add_concept("maraging_steel_300", ConceptType.MATERIAL,
            synonyms={"maraging steel", "18ni300", "maraging300"},
            definition="18Ni300 maraging steel – a precipitation‑hardenable steel with very high strength, used in tooling and aerospace.")

        # --- Processes / Technologies ---
        self._add_concept("lpbf", ConceptType.PROCESS,
            synonyms={"laser powder bed fusion", "l-pbf", "powder bed fusion", "pbf"},
            definition="Laser Powder Bed Fusion – an additive manufacturing process where a laser selectively melts metal powder layer by layer.")
        self._add_concept("slm", ConceptType.PROCESS,
            synonyms={"selective laser melting", "slm", "laser melting"},
            definition="Selective Laser Melting – a powder bed fusion technique using a high‑power laser to fully melt metal powder.")
        self._add_concept("ded", ConceptType.PROCESS,
            synonyms={"directed energy deposition", "ded", "laser metal deposition", "lmd"},
            definition="Directed Energy Deposition – an additive manufacturing process where material (powder or wire) is melted by a laser/electron beam as it is deposited.")
        self._add_concept("ebm", ConceptType.PROCESS,
            synonyms={"electron beam melting", "ebm", "eb-pbf"},
            definition="Electron Beam Melting – a powder bed fusion technique using an electron beam as the heat source, operating in vacuum.")
        self._add_concept("waam", ConceptType.PROCESS,
            synonyms={"wire arc additive manufacturing", "waam", "wire + arc"},
            definition="Wire Arc Additive Manufacturing – a DED process using an electric arc as heat source and wire as feedstock, for large‑scale components.")
        self._add_concept("laser_cladding", ConceptType.PROCESS,
            synonyms={"laser cladding", "lc", "laser deposition"},
            definition="Laser Cladding – a surface coating technique where a laser melts powder onto a substrate to improve wear or corrosion resistance.")
        self._add_concept("hot_isostatic_pressing", ConceptType.PROCESS,
            synonyms={"hip", "hot isostatic pressing"},
            definition="Hot Isostatic Pressing – a post‑process treatment applying high temperature and pressure to close internal porosity.")
        self._add_concept("heat_treatment", ConceptType.PROCESS,
            synonyms={"annealing", "aging", "solution treatment", "tempering", "stress relief"},
            definition="Heat treatment – post‑process thermal cycles to modify microstructure and relieve residual stresses.")
        self._add_concept("surface_finishing", ConceptType.PROCESS,
            synonyms={"post‑processing", "machining", "polishing", "laser polishing", "shot peening"},
            definition="Surface finishing – post‑process mechanical or chemical treatments to improve surface quality.")

        # --- Properties ---
        self._add_concept("porosity", ConceptType.PROPERTY,
            synonyms={"pores", "voids", "density", "relative density"},
            definition="Porosity – the volume fraction of voids in the material, a critical defect in AM parts.")
        self._add_concept("residual_stress", ConceptType.PROPERTY,
            synonyms={"stress", "thermal stress", "residual stress"},
            definition="Residual stress – internal stress locked in the material after rapid heating and cooling cycles during AM.")
        self._add_concept("hardness", ConceptType.PROPERTY,
            synonyms={"microhardness", "vickers hardness", "hv"},
            definition="Hardness – a measure of resistance to indentation, often used as a proxy for strength in AM parts.")
        self._add_concept("tensile_strength", ConceptType.PROPERTY,
            synonyms={"uts", "ultimate tensile strength", "yield strength", "elongation"},
            definition="Tensile strength – the maximum stress a material can withstand under tension; often evaluated in as‑built and heat‑treated conditions.")
        self._add_concept("fatigue_life", ConceptType.PROPERTY,
            synonyms={"fatigue", "cyclic loading", "endurance", "s‑n curve"},
            definition="Fatigue life – the number of cycles a part can withstand before failure under cyclic loading; critical for safety‑critical components.")
        self._add_concept("surface_roughness", ConceptType.PROPERTY,
            synonyms={"roughness", "ra", "rq", "surface finish", "topography"},
            definition="Surface roughness – the texture of the as‑built or post‑processed surface, affecting fatigue and corrosion resistance.")
        self._add_concept("elastic_modulus", ConceptType.PROPERTY,
            synonyms={"young's modulus", "stiffness", "e"},
            definition="Elastic modulus – a measure of stiffness; important for structural applications.")
        self._add_concept("corrosion_resistance", ConceptType.PROPERTY,
            synonyms={"corrosion", "pitting", "oxidation"},
            definition="Corrosion resistance – the ability to withstand chemical attack; important for marine and biomedical applications.")
        self._add_concept("thermal_conductivity", ConceptType.PROPERTY,
            synonyms={"thermal diffusivity", "kappa"},
            definition="Thermal conductivity – the ability to transfer heat; relevant for heat exchangers and thermal management.")

        # --- Phenomena ---
        self._add_concept("melt_pool", ConceptType.PHENOMENON,
            synonyms={"molten pool", "melt pool dynamics", "melt pool shape"},
            definition="Melt pool – the region of molten metal created by the laser/electron beam; its behaviour determines defect formation and microstructure.")
        self._add_concept("keyhole", ConceptType.PHENOMENON,
            synonyms={"keyhole porosity", "keyhole mode", "vapor depression"},
            definition="Keyhole – a deep vapour depression formed under high energy density; collapse leads to spherical pores.")
        self._add_concept("lack_of_fusion", ConceptType.PHENOMENON,
            synonyms={"lof", "lack of fusion", "interlayer porosity", "unmelted powder"},
            definition="Lack of fusion – defects arising from insufficient energy to fully melt and bond adjacent tracks or layers, leading to irregular pores.")
        self._add_concept("spatter", ConceptType.PHENOMENON,
            synonyms={"splashing", "droplet ejection", "spatter formation"},
            definition="Spatter – the ejection of molten particles from the melt pool, leading to surface contamination and defects.")
        self._add_concept("balling", ConceptType.PHENOMENON,
            synonyms={"balling effect", "spheroidisation", "bead instability"},
            definition="Balling – instability of the melt track causing the formation of spherical beads rather than continuous tracks, reducing density.")
        self._add_concept("solidification_cracking", ConceptType.PHENOMENON,
            synonyms={"hot cracking", "solidification cracking", "microcracking"},
            definition="Solidification cracking – cracks that form during solidification due to thermal contraction and alloy segregation.")
        self._add_concept("melt_pool_instability", ConceptType.PHENOMENON,
            synonyms={"unstable melt pool", "melt pool fluctuation"},
            definition="Melt pool instability – fluctuations in the melt pool geometry and flow, leading to irregular tracks and defects.")
        self._add_concept("thermal_gradient", ConceptType.PHENOMENON,
            synonyms={"temperature gradient", "cooling rate", "solidification front"},
            definition="Thermal gradient – the spatial variation of temperature, driving microstructure evolution and residual stress.")
        self._add_concept("epitaxial_growth", ConceptType.PHENOMENON,
            synonyms={"epitaxial growth", "columnar grains", "texture"},
            definition="Epitaxial growth – grain growth that continues from the substrate or previous layer, often leading to strong crystallographic texture.")
        self._add_concept("cet", ConceptType.PHENOMENON,
            synonyms={"columnar‑to‑equiaxed transition", "cet", "grain refinement"},
            definition="Columnar‑to‑Equiaxed Transition – the change from elongated columnar grains to fine equiaxed grains due to high undercooling and nucleants.")
        self._add_concept("microstructure_evolution", ConceptType.PHENOMENON,
            synonyms={"grain structure", "phase transformation", "precipitation"},
            definition="Microstructure evolution – the development of grain morphology, phase fractions, and precipitates during AM and post‑heat treatment.")
        self._add_concept("anisotropy", ConceptType.PHENOMENON,
            synonyms={"direction‑dependent", "texture", "orientation‑dependent properties"},
            definition="Anisotropy – the variation of material properties with build direction or loading direction, due to preferred grain orientation.")

        # --- Microstructure features ---
        self._add_concept("columnar_grains", ConceptType.MICROSTRUCTURE,
            synonyms={"columnar", "elongated grains", "directional grains"},
            definition="Columnar grains – elongated grains that grow in the build direction due to epitaxial solidification.")
        self._add_concept("equiaxed_grains", ConceptType.MICROSTRUCTURE,
            synonyms={"equiaxed", "fine grains", "isotropic grains"},
            definition="Equiaxed grains – grains with roughly equal dimensions, often associated with high nucleation rates and good mechanical properties.")
        self._add_concept("cellular_dendrites", ConceptType.MICROSTRUCTURE,
            synonyms={"cellular", "dendritic", "subgrains", "cell structure"},
            definition="Cellular/dendritic structure – fine sub‑grain features formed during rapid solidification, with solute segregation at boundaries.")
        self._add_concept("laves_phase", ConceptType.MICROSTRUCTURE,
            synonyms={"laves", "intermetallic", "laves precipitates"},
            definition="Laves phase – a brittle intermetallic phase that can form in Ni‑based superalloys, affecting ductility and cracking.")
        self._add_concept("precipitates", ConceptType.MICROSTRUCTURE,
            synonyms={"γ'", "γ''", "carbides", "nitrides", "δ phase"},
            definition="Precipitates – secondary phases formed during solidification or heat treatment, influencing strength and hardness.")

        # --- Parameters ---
        self._add_concept("laser_power", ConceptType.PARAMETER,
            synonyms={"power", "p", "laser energy"},
            definition="Laser power – the output power of the laser beam, directly influencing melt pool temperature and size.")
        self._add_concept("scan_speed", ConceptType.PARAMETER,
            synonyms={"velocity", "v", "scanning speed", "laser velocity"},
            definition="Scan speed – the speed at which the laser moves across the powder bed; affects exposure time and energy input.")
        self._add_concept("hatch_spacing", ConceptType.PARAMETER,
            synonyms={"hatch distance", "h", "line spacing"},
            definition="Hatch spacing – the distance between adjacent scan tracks; determines track overlap and fusion.")
        self._add_concept("layer_thickness", ConceptType.PARAMETER,
            synonyms={"t", "powder layer thickness"},
            definition="Layer thickness – the thickness of each powder layer; influences build time, energy penetration, and surface finish.")
        self._add_concept("energy_density", ConceptType.PARAMETER,
            synonyms={"ved", "volumetric energy density", "linear energy density"},
            definition="Energy density – a combined measure of laser power, scan speed, hatch spacing, and layer thickness, used to optimise process windows.")
        self._add_concept("preheat_temperature", ConceptType.PARAMETER,
            synonyms={"substrate temperature", "baseplate heating", "preheating"},
            definition="Preheating temperature – the temperature of the build plate, used to reduce thermal gradients and residual stress.")
        self._add_concept("scan_strategy", ConceptType.PARAMETER,
            synonyms={"scan pattern", "hatching strategy", "island scanning", "chessboard"},
            definition="Scan strategy – the path and pattern of the laser (e.g., bidirectional, island, spiral) affecting thermal history and defects.")
        self._add_concept("beam_diameter", ConceptType.PARAMETER,
            synonyms={"spot size", "laser spot diameter"},
            definition="Beam diameter – the size of the laser beam at the focal point; affects energy density and melt pool geometry.")
        self._add_concept("build_orientation", ConceptType.PARAMETER,
            synonyms={"build direction", "orientation", "printing direction"},
            definition="Build orientation – the direction in which the part is built; influences anisotropic properties and support structures.")

        # --- Methods ---
        self._add_concept("xct", ConceptType.METHOD,
            synonyms={"x‑ray computed tomography", "micro‑ct", "x‑ray tomography"},
            definition="X‑ray computed tomography – a non‑destructive imaging technique to characterise internal defects such as pores and cracks.")
        self._add_concept("sem", ConceptType.METHOD,
            synonyms={"scanning electron microscopy", "fesem", "sem imaging"},
            definition="Scanning electron microscopy – for high‑resolution imaging of surface morphology and fracture surfaces.")
        self._add_concept("ebsd", ConceptType.METHOD,
            synonyms={"electron backscatter diffraction", "crystallographic texture"},
            definition="Electron backscatter diffraction – a SEM‑based technique to determine crystallographic orientation and grain structure.")
        self._add_concept("xrd", ConceptType.METHOD,
            synonyms={"x‑ray diffraction", "powder diffraction"},
            definition="X‑ray diffraction – used for phase identification, residual stress measurement, and crystallite size estimation.")
        self._add_concept("tem", ConceptType.METHOD,
            synonyms={"transmission electron microscopy", "hr‑tem"},
            definition="Transmission electron microscopy – for examining sub‑micron features, precipitates, and dislocations.")
        self._add_concept("thermal_imaging", ConceptType.METHOD,
            synonyms={"infrared thermography", "pyrometry", "melt pool monitoring"},
            definition="Thermal imaging – in‑situ monitoring of melt pool temperature and geometry using infrared cameras.")
        self._add_concept("in_situ_monitoring", ConceptType.METHOD,
            synonyms={"in‑process monitoring", "real‑time monitoring", "sensor fusion"},
            definition="In‑situ monitoring – the collection of sensor data (optical, thermal, acoustic) during printing for quality control and defect detection.")
        self._add_concept("finite_element_analysis", ConceptType.METHOD,
            synonyms={"fea", "fem", "thermal simulation", "thermomechanical modelling"},
            definition="Finite element analysis – numerical simulation of thermal, mechanical, and fluid flow phenomena during AM.")
        self._add_concept("machine_learning", ConceptType.METHOD,
            synonyms={"ml", "deep learning", "neural networks", "data‑driven"},
            definition="Machine learning – data‑driven techniques for predicting properties, detecting defects, and optimising process parameters.")

        # Build synonym index and causal chains

        # --- Multicomponent alloy phenomena ---
        self._add_concept("selective_vaporization", ConceptType.PHENOMENON,
            synonyms={"elemental vaporization", "compositional drift", "vaporization loss"},
            definition="The preferential evaporation of high-vapor-pressure elements (e.g., Al, Zn, Mn) during laser melting, leading to a deviation from the nominal alloy composition.")
        self._add_concept("marangoni_convection", ConceptType.PHENOMENON,
            synonyms={"marangoni flow", "thermocapillary flow", "melt pool convection"},
            definition="Surface tension-driven fluid flow within the melt pool that governs heat and mass transport, critical for the homogenization of multicomponent alloys during in-situ alloying.")
        self._add_concept("solute_trapping", ConceptType.PHENOMENON,
            synonyms={"solute capture", "non-equilibrium solidification"},
            definition="A non-equilibrium solidification phenomenon where rapid cooling traps solute atoms in the matrix beyond their equilibrium solubility limits, extending solid solubility.")
        self._add_concept("recoil_pressure", ConceptType.PHENOMENON,
            synonyms={"vapor recoil", "laser ablation pressure"},
            definition="The pressure exerted by rapidly vaporizing metal atoms on the melt pool surface, causing keyhole formation and driving fluid flow.")
        self._add_concept("denudation_zone", ConceptType.PHENOMENON,
            synonyms={"powder denudation", "track depletion"},
            definition="The zone alongside the laser scan track where powder particles are blown away or entrained into the melt pool, causing localized powder depletion and compositional variations.")
        self._add_concept("phase_stability", ConceptType.PHENOMENON,
            synonyms={"phase equilibrium", "thermodynamic stability"},
            definition="The tendency of a multicomponent alloy to maintain intended phases under extreme non-equilibrium thermal conditions during LAM.")

        # --- Multicomponent alloy microstructure ---
        self._add_concept("dendritic_structure", ConceptType.MICROSTRUCTURE,
            synonyms={"dendrites", "dendritic morphology"},
            definition="A tree-like microstructural pattern formed during rapid solidification, where the spacing (SDAS) is dictated by the cooling rate and influences microsegregation in multicomponent alloys.")
        self._add_concept("metastable_phase", ConceptType.MICROSTRUCTURE,
            synonyms={"non-equilibrium phase", "retained metastable"},
            definition="A phase that exists in the as-built microstructure due to rapid quenching, which would not exist under slow-cooling equilibrium conditions.")
        self._add_concept("composition_gradient", ConceptType.MICROSTRUCTURE,
            synonyms={"compositional gradient", "core-shell structure"},
            definition="A spatial variation in chemical composition within a single track or grain, often resulting from incomplete mixing during in-situ alloying or selective vaporization.")
        self._add_concept("microsegregation", ConceptType.MICROSTRUCTURE,
            synonyms={"interdendritic segregation", "coring"},
            definition="Localized chemical inhomogeneity at the microscale, typically between dendrite arms, arising from partitioning of solute during rapid solidification.")

        # --- Multicomponent alloy parameters ---
        self._add_concept("cooling_rate", ConceptType.PARAMETER,
            synonyms={"quench rate", "solidification rate"},
            definition="The rate at which temperature decreases (K/s), governing microstructural scale, phase selection, and the degree of solute trapping in LAM.")
        self._add_concept("gr_ratio", ConceptType.PARAMETER,
            synonyms={"G/R ratio", "thermal gradient to solidification velocity"},
            definition="The ratio of thermal gradient (G) to solidification velocity (R), which determines the solidification morphology (planar, cellular, dendritic, or equiaxed).")
        self._add_concept("laser_absorptivity", ConceptType.PARAMETER,
            synonyms={"absorption coefficient", "laser energy coupling"},
            definition="The fraction of incident laser energy absorbed by the material, which varies with wavelength, surface roughness, temperature, and alloy composition.")
        self._add_concept("powder_packing_density", ConceptType.PARAMETER,
            synonyms={"bed density", "relative powder density"},
            definition="The density of the powder layer, affecting thermal conductivity, laser absorptivity, and the local chemical composition in blended multicomponent powders.")

        # --- Multicomponent alloy properties ---
        self._add_concept("printability", ConceptType.PROPERTY,
            synonyms={"processability", "additive manufacturability"},
            definition="The qualitative or quantitative measure of an alloy's ability to be successfully processed by LAM without severe defects like cracking, keyholing, or delamination.")
        self._add_concept("cracking_susceptibility", ConceptType.PROPERTY,
            synonyms={"solidification cracking tendency", "hot tearing index"},
            definition="The tendency of an alloy to form cracks during or immediately after solidification, often exacerbated by high thermal stresses and restricted solidification shrinkage in multicomponent systems.")
        self._add_concept("yield_strength", ConceptType.PROPERTY,
            synonyms={"yield stress", "0.2% proof strength"},
            definition="The stress at which a material begins to deform plastically; an important mechanical property for structural LAM parts.")
        self._add_concept("ductility", ConceptType.PROPERTY,
            synonyms={"elongation", "toughness", "strain to failure"},
            definition="The ability of a material to undergo significant plastic deformation before rupture, often inversely related to strength in as-built LAM parts.")

        # --- Multicomponent alloy materials ---
        self._add_concept("high_entropy_alloy", ConceptType.MATERIAL,
            synonyms={"hea", "complex concentrated alloy", "cca", "multi-principal element alloy"},
            definition="Alloys containing multiple principal elements in high concentrations, relying on high configurational entropy for phase stability, often processed via LAM for refined microstructures.")
    ...
    def _build_causal_chains(self) -> None:
        # Laser Additive Manufacturing causal chains
        causal_chains = [
            # Process parameters → melt pool
            ("laser_power", RelationshipType.INFLUENCES, "melt_pool", 0.85),
            ("scan_speed", RelationshipType.INFLUENCES, "melt_pool", -0.80),
            ("hatch_spacing", RelationshipType.INFLUENCES, "melt_pool", -0.70),
            ("layer_thickness", RelationshipType.INFLUENCES, "melt_pool", -0.65),
            ("preheat_temperature", RelationshipType.INFLUENCES, "thermal_gradient", -0.70),
            ("scan_strategy", RelationshipType.INFLUENCES, "thermal_gradient", 0.75),

            # Melt pool → defects
            ("melt_pool", RelationshipType.CAUSES, "keyhole", 0.80),
            ("melt_pool", RelationshipType.CAUSES, "spatter", 0.75),
            ("melt_pool", RelationshipType.CAUSES, "lack_of_fusion", -0.85),  # insufficient melting
            ("melt_pool", RelationshipType.CAUSES, "balling", 0.70),
            ("melt_pool", RelationshipType.INFLUENCES, "thermal_gradient", 0.90),

            # Thermal gradient → microstructure
            ("thermal_gradient", RelationshipType.INFLUENCES, "cooling_rate", 0.95),
            ("cooling_rate", RelationshipType.INFLUENCES, "columnar_grains", 0.80),
            ("cooling_rate", RelationshipType.INFLUENCES, "equiaxed_grains", -0.70),
            ("cooling_rate", RelationshipType.INFLUENCES, "cellular_dendrites", 0.75),
            ("thermal_gradient", RelationshipType.INFLUENCES, "residual_stress", 0.85),
            ("residual_stress", RelationshipType.CAUSES, "solidification_cracking", 0.70),

            # Microstructure → properties
            ("columnar_grains", RelationshipType.INFLUENCES, "anisotropy", 0.85),
            ("equiaxed_grains", RelationshipType.INFLUENCES, "hardness", 0.70),
            ("equiaxed_grains", RelationshipType.INFLUENCES, "ductility", 0.80),
            ("cellular_dendrites", RelationshipType.INFLUENCES, "yield_strength", 0.75),
            ("porosity", RelationshipType.INFLUENCES, "fatigue_life", -0.90),
            ("porosity", RelationshipType.INFLUENCES, "tensile_strength", -0.85),
            ("surface_roughness", RelationshipType.INFLUENCES, "fatigue_life", -0.80),
            ("residual_stress", RelationshipType.INFLUENCES, "tensile_strength", -0.60),
            ("residual_stress", RelationshipType.INFLUENCES, "fatigue_life", -0.70),
            ("hardness", RelationshipType.INFLUENCES, "tensile_strength", 0.75),

            # Process → properties
            ("lpbf", RelationshipType.INFLUENCES, "porosity", -0.60),
            ("slm", RelationshipType.INFLUENCES, "porosity", -0.60),
            ("ebm", RelationshipType.INFLUENCES, "residual_stress", -0.50),  # lower residual stress
            ("heat_treatment", RelationshipType.INFLUENCES, "hardness", 0.70),
            ("heat_treatment", RelationshipType.INFLUENCES, "tensile_strength", 0.65),
            ("hot_isostatic_pressing", RelationshipType.INFLUENCES, "porosity", -0.90),

            # Methods → measurements
            ("xct", RelationshipType.MEASURES, "porosity", 0.95),
            ("xrd", RelationshipType.MEASURES, "residual_stress", 0.85),
            ("sem", RelationshipType.MEASURES, "surface_roughness", 0.85),
            ("ebsd", RelationshipType.MEASURES, "columnar_grains", 0.90),
            ("thermal_imaging", RelationshipType.MEASURES, "melt_pool", 0.90),
            ("finite_element_analysis", RelationshipType.MODELS, "thermal_gradient", 0.90),
            ("machine_learning", RelationshipType.PREDICTS, "porosity", 0.80),

            # Multicomponent alloy uncertainties
            # Vaporization & Composition
            ("laser_power", RelationshipType.CAUSES, "selective_vaporization", 0.85),
            ("selective_vaporization", RelationshipType.CAUSES, "composition_gradient", 0.80),
            ("selective_vaporization", RelationshipType.INFLUENCES, "phase_stability", -0.70),

            # In-situ Mixing
            ("marangoni_convection", RelationshipType.INFLUENCES, "composition_gradient", -0.85),
            ("scan_speed", RelationshipType.INFLUENCES, "marangoni_convection", -0.60),
            ("composition_gradient", RelationshipType.CAUSES, "microsegregation", 0.80),

            # Solidification
            ("cooling_rate", RelationshipType.CAUSES, "solute_trapping", 0.90),
            ("cooling_rate", RelationshipType.INFLUENCES, "metastable_phase", 0.75),
            ("cooling_rate", RelationshipType.INFLUENCES, "dendritic_structure", 0.80),
            ("gr_ratio", RelationshipType.INFLUENCES, "dendritic_structure", 0.85),

            # Printability & Cracking
            ("composition_gradient", RelationshipType.CAUSES, "cracking_susceptibility", 0.70),
            ("thermal_gradient", RelationshipType.CAUSES, "cracking_susceptibility", 0.85),
            ("cracking_susceptibility", RelationshipType.INFLUENCES, "printability", -0.95),

            # Recoil Pressure & Melt Pool
            ("selective_vaporization", RelationshipType.CAUSES, "recoil_pressure", 0.80),
            ("recoil_pressure", RelationshipType.CAUSES, "keyhole", 0.85),
        ]
...
# ============================================================================
# ADVANCED CONCEPT RESOLVER (unchanged architecture)
# ============================================================================
class AdvancedConceptResolver:
    """
    Multi-level concept resolution using ontology, embeddings, and context.
    Unchanged from the original; relies on the domain ontology.
    """
    def __init__(
        self,
    ...
    def _context_disambiguation(self, text: str, context: str) -> Optional[str]:
        ...
        # LAM indicators
        lam_indicators = [
            'laser', 'powder', 'bed', 'melt', 'pool', 'fusion', 'porosity',
            'residual stress', 'hardness', 'tensile', 'fatigue', 'scan',
            'hatch', 'layer', 'energy', 'density', 'microstructure', 'grain'
        ]
        if any(ind in context_lower for ind in lam_indicators):
            if 'porosity' in text or 'pore' in text:
                return "porosity"
            if 'stress' in text or 'residual' in text:
                return "residual_stress"
            if 'hardness' in text:
                return "hardness"
            if 'tensile' in text or 'strength' in text:
                return "tensile_strength"
            if 'melt' in text and 'pool' in text:
                return "melt_pool"
            if 'keyhole' in text:
                return "keyhole"
            if 'lack of fusion' in text or 'lof' in text:
                return "lack_of_fusion"
        return None


# ============================================================================
# ENHANCED CONCEPT EXTRACTOR (LAM patterns)
# ============================================================================
class EnhancedConceptExtractor:
    ...
    def _build_extraction_patterns(self) -> None:
        ...
        self.material_patterns = [
            r'\bti[-]?6al[-]?4v\b', r'\bti64\b',
            r'\binconel[-\s]718\b', r'\bin718\b',
            r'\b316l\b', r'\bstainless\s+steel\s+316l\b',
            r'\balsi10mg\b', r'\bal[-]?si[-]?10mg\b',
            r'\bhastelloy[-\s]x\b',
            r'\bcucrzr\b', r'\bcu[-]?cr[-]?zr\b',
            r'\bm50nil\b',
            r'\bti[-]?5553\b',
            r'\binconel[-\s]625\b', r'\bin625\b',
            r'\bcm247lc\b',
            r'\bni[-]?20zr\b', r'\bni[-]?5al\b', r'\bni[-]?5nb\b',
            r'\bco[-]?cr[-]?mo\b',
            r'\bcopper\b', r'\bcu\b', r'\btungsten\b', r'\bmolybdenum\b', r'\btantalum\b',
            r'\bh13\s+tool\s+steel\b',
            r'\bmaraging\s+steel\b', r'\b18ni300\b',
        ]
        # Process patterns
        self.process_patterns = [
            r'\blaser\s+powder\s+bed\s+fusion\b', r'\blpbf\b',
            r'\bselective\s+laser\s+melting\b', r'\bslm\b',
            r'\bdirected\s+energy\s+deposition\b', r'\bded\b',
            r'\blaser\s+metal\s+deposition\b', r'\blmd\b',
            r'\belectron\s+beam\s+melting\b', r'\bebm\b',
            r'\bwire\s+arc\s+additive\s+manufacturing\b', r'\bwaam\b',
            r'\blaser\s+cladding\b',
            r'\bhot\s+isostatic\s+pressing\b', r'\bhip\b',
            r'\bheat\s+treatment\b', r'\baging\b', r'\bsolution\s+annealing\b',
            r'\bsurface\s+finishing\b', r'\blaser\s+polishing\b',
        ]
        # Property patterns
        self.property_patterns = [
            r'\bporosity\b', r'\bpore\b', r'\bdensity\b',
            r'\bresidual\s+stress\b',
            r'\bhardness\b', r'\bmicrohardness\b',
            r'\btensile\s+strength\b', r'\byt\b', r'\buts\b',
            r'\bfatigue\b', r'\bcyclic\s+loading\b',
            r'\bsurface\s+roughness\b', r'\bra\b',
            r'\belastic\s+modulus\b', r'\byoung\'s\s+modulus\b',
            r'\bcorrosion\s+resistance\b',
            r'\bthermal\s+conductivity\b',
        ]
        # Phenomenon patterns
        self.phenomenon_patterns = [
            r'\bmelt\s+pool\b', r'\bmolten\s+pool\b',
            r'\bkeyhole\b',
            r'\black\s+of\s+fusion\b', r'\blof\b',
            r'\bspatter\b',
            r'\bballing\b',
            r'\bsolidification\s+cracking\b', r'\bhot\s+cracking\b',
            r'\bmelt\s+pool\s+instability\b',
            r'\bthermal\s+gradient\b',
            r'\bepitaxial\s+growth\b',
            r'\bcolumnar[-]?to[-]?equiaxed\s+transition\b', r'\bcet\b',
            r'\bmicrostructure\s+evolution\b',
            r'\banisotropy\b',
        ]
        # Microstructure patterns
        self.microstructure_patterns = [
            r'\bcolumnar\s+grains\b', r'\bcolumnar\b',
            r'\bequiaxed\s+grains\b', r'\bequiaxed\b',
            r'\bcellular\s+dendrites\b', r'\bcellular\s+structure\b',
            r'\blaves\s+phase\b',
            r'\bprecipitates\b', r'\bgamma\s+prime\b', r'\bgamma\s+double\s+prime\b',
        ]
        # Parameter patterns
        self.param_patterns = [
            r'\blaser\s+power\b',
            r'\bscan\s+speed\b',
            r'\bhatch\s+spacing\b',
            r'\blayer\s+thickness\b',
            r'\benergy\s+density\b', r'\bvolumetric\s+energy\s+density\b',
            r'\bpreheat\s+temperature\b',
            r'\bscan\s+strategy\b', r'\bscan\s+pattern\b',
            r'\bbeam\s+diameter\b', r'\bspot\s+size\b',
            r'\bbuild\s+orientation\b',
        ]
        # Method patterns
        self.method_patterns = [
            r'\bx[-]?ray\s+computed\s+tomography\b', r'\bxct\b', r'\bmicro[-]?ct\b',
            r'\bscanning\s+electron\s+microscopy\b', r'\bsem\b',
            r'\belectron\s+backscatter\s+diffraction\b', r'\bebsd\b',
            r'\bx[-]?ray\s+diffraction\b', r'\bxrd\b',
            r'\btransmission\s+electron\s+microscopy\b', r'\btem\b',
            r'\binfrared\s+thermography\b', r'\bthermal\s+imaging\b',
            r'\bin[-]?situ\s+monitoring\b',
            r'\bfinite\s+element\s+analysis\b', r'\bfea\b',
            r'\bmachine\s+learning\b', r'\bdeep\s+learning\b',
        ]
        self.all_patterns = (
            self.material_patterns + self.process_patterns + self.property_patterns +
            self.phenomenon_patterns + self.microstructure_patterns +
...
# ============================================================================
# UTILITY FUNCTIONS (LAM-specific metric extraction)
# ============================================================================
...
# ============================================================================
# VAE-REGRESSOR INTEGRATION (placeholder)
# ============================================================================
@st.cache_resource(show_spinner=False)
def load_vae_model(model_path: str = "vae_regressor.pt"):
    try:
        if os.path.exists(model_path):
            return lambda x, y: 200.0  # dummy
        else:
            return lambda x, y: 150.0
    except Exception:
        return lambda x, y: 150.0


def predict_property(composition_str: str, temperature_k: float, vae_model) -> float:
    return vae_model(np.zeros(66), temperature_k)


# ============================================================================
# LAM KEYWORDS & PATTERNS (for legacy extraction)
# ============================================================================
MATERIAL_KEYWORDS = [
    "ti-6al-4v", "inconel 718", "316l", "alsi10mg", "hastelloy x",
    "cucrzr", "m50nil", "ti-5553", "inconel 625", "cm247lc",
    "co-cr-mo", "copper", "tungsten", "molybdenum", "tantalum",
    "h13 tool steel", "maraging steel"
]
PROCESS_KEYWORDS = [
    ...
    "laser cladding", "hot isostatic pressing", "hip", "heat treatment",
    "surface finishing", "laser polishing"
]
PROPERTY_KEYWORDS = [
    "porosity", "density", "residual stress", "hardness", "tensile strength",
    "yield strength", "ultimate tensile strength", "fatigue", "surface roughness",
    "elastic modulus", "corrosion resistance", "thermal conductivity"
]
PHENOMENON_KEYWORDS = [
    "melt pool", "keyhole", "lack of fusion", "spatter", "balling",
    "solidification cracking", "melt pool instability", "thermal gradient",
    "epitaxial growth", "columnar-to-equiaxed transition", "microstructure evolution",
    "anisotropy"
]
MICROSTRUCTURE_KEYWORDS = [
    "columnar grains", "equiaxed grains", "cellular dendrites", "laves phase",
    "precipitates", "gamma prime", "gamma double prime"
]
PARAM_KEYWORDS = [
    "laser power", "scan speed", "hatch spacing", "layer thickness",
    "energy density", "volumetric energy density", "preheat temperature",
    "scan strategy", "beam diameter", "spot size", "build orientation"
]
METHOD_KEYWORDS = [
    "x-ray computed tomography", "xct", "micro-ct", "scanning electron microscopy",
    "sem", "electron backscatter diffraction", "ebsd", "x-ray diffraction", "xrd",
    "transmission electron microscopy", "tem", "infrared thermography",
    "thermal imaging", "in-situ monitoring", "finite element analysis", "fea",
    "machine learning", "deep learning"
]
ALL_DOMAIN_KEYWORDS = (
    MATERIAL_KEYWORDS + PROCESS_KEYWORDS + PROPERTY_KEYWORDS +
    PHENOMENON_KEYWORDS + MICROSTRUCTURE_KEYWORDS +
    PARAM_KEYWORDS + METHOD_KEYWORDS
)
...
LAM_PATTERNS = [
    ...
    r'\bcm247lc\b',
    r'\bco[-]?cr[-]?mo\b',
    r'\bcopper\b', r'\btungsten\b', r'\bmolybdenum\b', r'\btantalum\b',
    r'\bh13\s+tool\s+steel\b',
    r'\bmaraging\s+steel\b', r'\b18ni300\b',
    r'\blaser\s+powder\s+bed\s+fusion\b', r'\blpbf\b',
    r'\bselective\s+laser\s+melting\b', r'\bslm\b',
...
LAM_DESCRIPTOR_MAPPING = {
    r'ti-6al-4v|inconel 718|316l|alsi10mg|hastelloy x|cucrzr|m50nil|ti-5553|inconel 625|cm247lc|co-cr-mo|copper|tungsten|molybdenum|tantalum|h13 tool steel|maraging steel': 'material',
    r'laser powder bed fusion|lpbf|selective laser melting|slm|directed energy deposition|ded|laser metal deposition|lmd|electron beam melting|ebm|wire arc additive manufacturing|waam|laser cladding|hot isostatic pressing|hip|heat treatment|surface finishing|laser polishing': 'process',
    r'porosity|density|residual stress|hardness|tensile strength|yield strength|ultimate tensile strength|fatigue|surface roughness|elastic modulus|corrosion resistance|thermal conductivity': 'property',
    r'melt pool|keyhole|lack of fusion|spatter|balling|solidification cracking|melt pool instability|thermal gradient|epitaxial growth|columnar-to-equiaxed transition|microstructure evolution|anisotropy': 'phenomenon',
    r'columnar grains|equiaxed grains|cellular dendrites|laves phase|precipitates|gamma prime|gamma double prime': 'microstructure',
    r'laser power|scan speed|hatch spacing|layer thickness|energy density|volumetric energy density|preheat temperature|scan strategy|beam diameter|spot size|build orientation': 'parameter',
    r'x-ray computed tomography|xct|micro-ct|scanning electron microscopy|sem|electron backscatter diffraction|ebsd|x-ray diffraction|xrd|transmission electron microscopy|tem|infrared thermography|thermal imaging|in-situ monitoring|finite element analysis|fea|machine learning|deep learning': 'method',
    r'general': 'general'
}


def normalize_lam_concept(concept: str) -> str:
    concept = concept.lower().strip()
    mapping = {
        r'ti-6al-4v|ti64': 'ti_6al_4v',
        r'inconel 718|in718': 'inconel_718',
        r'316l|stainless steel 316l': 'aisi_316l',
        r'alsi10mg': 'alsi10mg',
        r'hastelloy x': 'hastelloy_x',
        r'cucrzr': 'cu_crzr',
        r'm50nil': 'm50nil',
        r'ti-5553': 'ti_5553',
        r'inconel 625|in625': 'inconel_625',
        r'cm247lc': 'cm247lc',
        r'co-cr-mo': 'co_cr_mo',
        r'tungsten': 'tungsten',
        r'molybdenum': 'molybdenum',
        r'tantalum': 'ta',
        r'h13 tool steel': 'h13_tool_steel',
        r'maraging steel|18ni300': 'maraging_steel_300',
        r'laser powder bed fusion|lpbf': 'lpbf',
        r'selective laser melting|slm': 'slm',
        r'directed energy deposition|ded|laser metal deposition|lmd': 'ded',
        r'electron beam melting|ebm': 'ebm',
        r'wire arc additive manufacturing|waam': 'waam',
        r'laser cladding': 'laser_cladding',
        r'hot isostatic pressing|hip': 'hot_isostatic_pressing',
        r'heat treatment|aging|annealing': 'heat_treatment',
        r'surface finishing|laser polishing': 'surface_finishing',
        r'porosity|pore|density': 'porosity',
        r'residual stress': 'residual_stress',
        r'hardness|microhardness': 'hardness',
        r'tensile strength|uts|yield strength': 'tensile_strength',
        r'fatigue': 'fatigue_life',
        r'surface roughness|ra': 'surface_roughness',
        r'elastic modulus|young\'s modulus': 'elastic_modulus',
        r'corrosion resistance': 'corrosion_resistance',
        r'thermal conductivity': 'thermal_conductivity',
        r'melt pool|molten pool': 'melt_pool',
        r'keyhole': 'keyhole',
        r'lack of fusion|lof': 'lack_of_fusion',
        r'spatter': 'spatter',
        r'balling': 'balling',
        r'solidification cracking|hot cracking': 'solidification_cracking',
        r'melt pool instability': 'melt_pool_instability',
        r'thermal gradient': 'thermal_gradient',
        r'epitaxial growth': 'epitaxial_growth',
        r'columnar-to-equiaxed transition|cet': 'cet',
        r'microstructure evolution': 'microstructure_evolution',
        r'anisotropy': 'anisotropy',
        r'columnar grains': 'columnar_grains',
        r'equiaxed grains': 'equiaxed_grains',
        r'cellular dendrites': 'cellular_dendrites',
        r'laves phase': 'laves_phase',
        r'precipitates|gamma prime|gamma double prime': 'precipitates',
        r'laser power': 'laser_power',
        r'scan speed': 'scan_speed',
        r'hatch spacing': 'hatch_spacing',
        r'layer thickness': 'layer_thickness',
        r'energy density|volumetric energy density': 'energy_density',
        r'preheat temperature': 'preheat_temperature',
        r'scan strategy|scan pattern': 'scan_strategy',
        r'beam diameter|spot size': 'beam_diameter',
        r'build orientation': 'build_orientation',
        r'x-ray computed tomography|xct|micro-ct': 'xct',
        r'scanning electron microscopy|sem': 'sem',
        r'electron backscatter diffraction|ebsd': 'ebsd',
        r'x-ray diffraction|xrd': 'xrd',
        r'transmission electron microscopy|tem': 'tem',
        r'infrared thermography|thermal imaging': 'thermal_imaging',
        r'in-situ monitoring': 'in_situ_monitoring',
        r'finite element analysis|fea': 'finite_element_analysis',
        r'machine learning|deep learning': 'machine_learning',
    }
...
def is_valid_lam_concept(concept: str) -> bool:
    concept_lower = concept.lower()
    has_domain = any(kw.lower() in concept_lower for kw in ALL_DOMAIN_KEYWORDS)
    has_pattern = any(re.search(p, concept, re.I) for p in LAM_PATTERNS)
    generic = {
        'study', 'analysis', 'effect', 'role', 'investigation', 'research',
        'method', 'approach', 'paper', 'work', 'using', 'based', 'novel',
        'additive manufacturing', 'metal', 'component', 'system', 'sample',
        'specimen', 'structure', 'surface', 'property', 'performance'
    }
...
def extract_concepts_from_text(text: str) -> List[str]:
    concepts: Set[str] = set()
    text_lower = text.lower()
    for pattern in LAM_PATTERNS:
        matches = re.findall(pattern, text, re.I)
        for m in matches:
            concept = m.lower().strip().rstrip('.').rstrip(',')
            if len(concept.split()) >= 1 and len(concept) > 3:
                concepts.add(concept)
    # Additional noun phrase extraction for material notation (e.g., Ti-6Al-4V)
    material_pattern = r'\b([A-Z][a-z]?\d*[-]?\d*[A-Z]?[a-z]?\d*)\b'
    matches = re.findall(material_pattern, text)
    for m in matches:
        concept = m.strip()
        if is_valid_lam_concept(concept):
            concepts.add(concept)
...
def extract_concepts_from_abstracts(df: pd.DataFrame, text_columns: List[str]) -> Tuple[List[List[str]], List[Dict]]:
    ...
    for idx, row in df.iterrows():
        ...
        # Extract porosity percentage
        por_matches = re.findall(r'(\d+(?:\.\d+)?)\s*(?:%|percent)', combined_text, re.I)
        if por_matches:
            metrics['porosity_percent'] = [float(m) for m in por_matches]
        # Extract hardness (HV)
        hv_matches = re.findall(r'(\d+(?:\.\d+)?)\s*HV', combined_text, re.I)
        if hv_matches:
            metrics['hardness_HV'] = [float(m) for m in hv_matches]
        # Tensile strength (MPa)
        ts_matches = re.findall(r'(\d+(?:\.\d+)?)\s*(?:MPa|GPa)', combined_text, re.I)
        if ts_matches:
            metrics['tensile_strength_MPa'] = [float(m) for m in ts_matches]
        # Surface roughness (Ra)
        ra_matches = re.findall(r'Ra\s*=\s*(\d+(?:\.\d+)?)', combined_text, re.I)
        if ra_matches:
            metrics['roughness_Ra'] = [float(m) for m in ra_matches]
        all_metrics.append(metrics)
        concepts = extract_concepts_from_text(combined_text)
        normalized = [normalize_lam_concept(c) for c in concepts]
...
def normalize_and_filter_concepts(all_concepts: List[List[str]], config: Dict) -> Tuple[List[str], Dict[str, int], Dict[int, str], Dict[str, List[int]]]:
    ...
    for doc_idx, concepts in enumerate(all_concepts):
        ...
        for c in concepts:
            if c not in seen_in_doc and is_valid_lam_concept(c):
                concept_counts[c] += 1
...
def abstract_concepts_to_categories(concepts: List[str]) -> Dict[str, str]:
    ...
    for concept in concepts:
        matched = False
        for pattern, category in LAM_DESCRIPTOR_MAPPING.items():
            if re.search(pattern, concept, re.I):
                concept_to_abstract[concept] = category
                matched = True
                break
        if not matched:
            if any(re.search(p, concept, re.I) for p in [r'ti-6al-4v', r'inconel', r'316l', r'alsi10mg', r'hastelloy', r'cucrzr', r'm50nil', r'ti-5553', r'co-cr-mo', r'tungsten', r'molybdenum', r'tantalum', r'h13', r'maraging']):
                concept_to_abstract[concept] = 'material'
            elif any(re.search(p, concept, re.I) for p in [r'lpbf', r'slm', r'ded', r'ebm', r'waam', r'laser cladding', r'hip', r'heat treatment']):
                concept_to_abstract[concept] = 'process'
            elif any(re.search(p, concept, re.I) for p in [r'porosity', r'density', r'stress', r'hardness', r'tensile', r'fatigue', r'surface roughness']):
                concept_to_abstract[concept] = 'property'
            elif any(re.search(p, concept, re.I) for p in [r'melt pool', r'keyhole', r'lack of fusion', r'spatter', r'balling', r'cracking', r'thermal gradient', r'epitaxial', r'cet', r'microstructure', r'anisotropy']):
                concept_to_abstract[concept] = 'phenomenon'
            elif any(re.search(p, concept, re.I) for p in [r'columnar', r'equiaxed', r'cellular', r'dendrites', r'laves', r'precipitates']):
                concept_to_abstract[concept] = 'microstructure'
            elif any(re.search(p, concept, re.I) for p in [r'laser power', r'scan speed', r'hatch', r'layer thickness', r'energy density', r'preheat', r'scan strategy', r'beam diameter', r'build orientation']):
                concept_to_abstract[concept] = 'parameter'
            elif any(re.search(p, concept, re.I) for p in [r'xct', r'sem', r'ebsd', r'xrd', r'tem', r'thermography', r'in-situ monitoring', r'fea', r'machine learning']):
...
# ============================================================================
# MICROTRANSFORMER #2: KG-RAG EXTRACTOR (LatentMoE) – LAM adapted experts
# ============================================================================
RELATIONSHIP_TO_IDX = {rel.name: i for i, rel in enumerate(RelationshipType)}
NUM_EDGE_TYPES = len(RelationshipType)

LAM_EXPERT_LABELS = [
    "Laser Power Effects", "Scan Speed", "Hatch Spacing", "Layer Thickness",
    "Energy Density", "Preheating", "Scan Strategy", "Beam Shaping",
    "Melt Pool Geometry", "Keyhole Stability", "Lack of Fusion", "Spatter Control",
    "Porosity Formation", "Residual Stress", "Solidification Cracking",
    "Thermal Gradients", "Cooling Rate", "Columnar Grains", "Equiaxed Grains",
    "Cellular Dendrites", "Precipitate Phases", "Laves Phase",
    "Tensile Strength", "Hardness", "Fatigue Life", "Surface Roughness",
    "Corrosion Resistance", "Heat Treatment Effects", "HIP Densification",
    "In-situ Monitoring", "XCT Defect Detection", "Process Simulation"
]
...
def export_publication_figure(
    ...
    filename="lam_graph_pub.png",
) -> bytes:
    try:
        pos = nx.spring_layout(nx_graph, seed=42, k=2.5, iterations=200)
        plt.figure(figsize=figsize, dpi=dpi)
        node_colors = [get_lam_category_color(n) for n in nx_graph.nodes()]
        node_sizes = [
        ...
        plt.title(
            "Laser Additive Manufacturing Concept Graph",
...
def generate_analysis_report(
    ...
    report: List[str] = []
    report.append("# Laser Additive Manufacturing Concept Graph Analysis Report")
    report.append(
    ...
    report.append("")
    report.append("---")
    report.append("*Report generated by Laser Additive Manufacturing Concept Graph v1.0*")
    return "\n".join(report)
...
# ============================================================================
# VISUALIZATION FUNCTIONS (LAM color mapping)
# ============================================================================
def get_lam_category_color(concept: str, cmap_colors: Optional[List[str]] = None) -> str:
    if cmap_colors:
        return cmap_colors[hash(concept) % len(cmap_colors)]
    concept_lower = concept.lower()
    category = 'general'
    for pattern, cat in LAM_DESCRIPTOR_MAPPING.items():
...
# Alias for compatibility (kept for backward compatibility)
get_mpea_category_color = get_lam_category_color


# ============================================================================
# PYVIS RENDERER (adapted to LAM hierarchy)
# ============================================================================
_NODE_TYPE_COLORS = {
...
_HIERARCHY_PARENTS = {
    # Root domain
    "laser_additive_manufacturing": (None, 0),
    # Tier 1: Materials
    "ti_6al_4v": ("Materials", 1),
    "inconel_718": ("Materials", 1),
    "aisi_316l": ("Materials", 1),
    "alsi10mg": ("Materials", 1),
    "hastelloy_x": ("Materials", 1),
    "cu_crzr": ("Materials", 1),
    "m50nil": ("Materials", 1),
    "ti_5553": ("Materials", 1),
    "inconel_625": ("Materials", 1),
    "cm247lc": ("Materials", 1),
    "co_cr_mo": ("Materials", 1),
    "pure_cu": ("Materials", 1),
    "tungsten": ("Materials", 1),
    "molybdenum": ("Materials", 1),
    "ta": ("Materials", 1),
    "h13_tool_steel": ("Materials", 1),
    "maraging_steel_300": ("Materials", 1),
    # Tier 1: Processes
    "lpbf": ("Processes", 1),
    "slm": ("Processes", 1),
    "ded": ("Processes", 1),
    "ebm": ("Processes", 1),
    "waam": ("Processes", 1),
    "laser_cladding": ("Processes", 1),
    "hot_isostatic_pressing": ("Processes", 1),
    "heat_treatment": ("Processes", 1),
    "surface_finishing": ("Processes", 1),
    # Tier 1: Properties
    "porosity": ("Properties", 1),
    "residual_stress": ("Properties", 1),
    "hardness": ("Properties", 1),
    "tensile_strength": ("Properties", 1),
    "fatigue_life": ("Properties", 1),
    "surface_roughness": ("Properties", 1),
    "elastic_modulus": ("Properties", 1),
    "corrosion_resistance": ("Properties", 1),
    "thermal_conductivity": ("Properties", 1),
    # Tier 1: Phenomena
    "melt_pool": ("Phenomena", 1),
    "keyhole": ("Phenomena", 1),
    "lack_of_fusion": ("Phenomena", 1),
    "spatter": ("Phenomena", 1),
    "balling": ("Phenomena", 1),
    "solidification_cracking": ("Phenomena", 1),
    "melt_pool_instability": ("Phenomena", 1),
    "thermal_gradient": ("Phenomena", 1),
    "epitaxial_growth": ("Phenomena", 1),
    "cet": ("Phenomena", 1),
    "microstructure_evolution": ("Phenomena", 1),
    "anisotropy": ("Phenomena", 1),
    # Tier 1: Microstructure
    "columnar_grains": ("Microstructure", 1),
    "equiaxed_grains": ("Microstructure", 1),
    "cellular_dendrites": ("Microstructure", 1),
    "laves_phase": ("Microstructure", 1),
    "precipitates": ("Microstructure", 1),
    # Tier 1: Parameters
    "laser_power": ("Parameters", 1),
    "scan_speed": ("Parameters", 1),
    "hatch_spacing": ("Parameters", 1),
    "layer_thickness": ("Parameters", 1),
    "energy_density": ("Parameters", 1),
    "preheat_temperature": ("Parameters", 1),
    "scan_strategy": ("Parameters", 1),
    "beam_diameter": ("Parameters", 1),
    "build_orientation": ("Parameters", 1),
    # Tier 1: Methods
    "xct": ("Methods", 1),
    "sem": ("Methods", 1),
    "ebsd": ("Methods", 1),
    "xrd": ("Methods", 1),
    "tem": ("Methods", 1),
    "thermal_imaging": ("Methods", 1),
    "in_situ_monitoring": ("Methods", 1),
    "finite_element_analysis": ("Methods", 1),
    "machine_learning": ("Methods", 1),
}
...
def get_hierarchy_path(concept_key: str) -> List[str]:
    ...
    if entry is None or entry[0] is None:
        return ["Laser Additive Manufacturing", leaf]
    parent_label = entry[0]
    return ["Laser Additive Manufacturing", parent_label, leaf]
...
def build_sunburst_data(graph: nx.Graph, node_weights: Optional[Dict[str, float]] = None, min_weight: float = 0.0) -> Tuple[List[str], List[str], List[float], List[str]]:
    ...
    values: List[float] = []
    parents: List[str] = []
    root_id = "Laser Additive Manufacturing"
    ids.append(root_id)
    labels.append("Laser Additive Manufacturing")
    values.append(0)
    parents.append("")
...
def render_pyvis_graph(
    ...
    for i, node in enumerate(nx_graph.nodes()):
        ...
        color = get_lam_category_color(node, cmap_colors)
    ...
    try:
        ...
        st.download_button(
            ...
            data=html_bytes,
            file_name="lam_concept_graph.html",
            mime="text/html"
        )
...
# ============================================================================
# SUNBURST & RADAR CHARTS (LAM hierarchy)
# ============================================================================
...
def build_category_hierarchy(
    ...
    parents: List[str] = []
    values: List[int] = []
    root_label = "Laser Additive Manufacturing"
...
def render_sunburst_chart(
    ...
    fig.update_layout(
        ...
        title=dict(text=f"<b>Hierarchical Concept Map (Laser Additive Manufacturing)</b><br><sup>★ Parent | ★□ Child | ★□◆ Grandchild — Hover for names</sup>", font=dict(size=16, family=font_family))
    )
    st.plotly_chart(fig, use_container_width=True)
    ...
    if export_format == "GraphML":
        try:
            if include_metadata:
                ...
                nx_graph.graph['tool'] = 'LAM-ConceptGraph'
            try:
                nx.write_graphml_lxml(nx_graph, "lam_graph.graphml")
            except Exception:
                nx.write_graphml(nx_graph, "lam_graph.graphml")
            with open("lam_graph.graphml", "rb") as f:
                return f.read(), "application/graphml+xml", "lam_graph.graphml"
        except Exception as e:
        ...
        return json_str.encode('utf-8'), "application/json", "lam_graph_full.json"
    elif export_format == "JSON (Compact)":
        data = nx.node_link_data(nx_graph)
        json_str = json.dumps(data, indent=2, default=str)
        return json_str.encode('utf-8'), "application/json", "lam_graph.json"
        ...
        return csv_df.to_csv(index=False).encode('utf-8'), "text/csv", "lam_edges_enhanced.csv"
        ...
        return csv_df.to_csv(index=False).encode('utf-8'), "text/csv", "lam_nodes_enhanced.csv"
    elif export_format == "PNG":
        try:
            pos = nx.spring_layout(nx_graph, seed=42)
            plt.figure(figsize=(14, 12), dpi=300)
            node_colors = [
                get_lam_category_color(n) for n in nx_graph.nodes()
            ]
            nx.draw(
            ...
            buf.seek(0)
            plt.close()
            return buf.read(), "image/png", "lam_graph.png"
        except Exception as e:
        ...
        try:
            ...
            buf.seek(0)
            plt.close()
            return buf.read(), "image/svg+xml", "lam_graph.svg"
        except Exception as e:
        ...
        try:
            if include_metadata:
                nx_graph.graph['created'] = datetime.now().isoformat()
                nx_graph.graph['version'] = '1.0'
            nx.write_gexf(nx_graph, "lam_graph.gexf")
            with open("lam_graph.gexf", "rb") as f:
                return f.read(), "application/xml", "lam_graph.gexf"
        except Exception as e:
...
def render_reasoning_dashboard(nx_graph, valid_concepts, ontology, extractor) -> None:
    ...
    if rel_types:
        ...
        st.plotly_chart(fig, use_container_width=True)
    st.subheader("🔗 Inferred Process-Structure-Property Chains")
    material_nodes = [
        c for c in valid_concepts
        if c in ontology.concepts
...
# ============================================================================
# BATCH PROCESSING MODE (unchanged)
# ============================================================================
...
def extract_doc_metrics(text: str) -> Dict[str, Any]:
    """Regex metric extraction for LAM literature."""
    metrics: Dict[str, Any] = {}
    # Porosity percentage
    por_matches = re.findall(r'(\d+(?:\.\d+)?)\s*(?:%|percent)', text, re.I)
    if por_matches:
        metrics['porosity_percent'] = [float(m) for m in por_matches]
    # Hardness (HV)
    hv_matches = re.findall(r'(\d+(?:\.\d+)?)\s*HV', text, re.I)
    if hv_matches:
        metrics['hardness_HV'] = [float(m) for m in hv_matches]
    # Tensile strength (MPa)
    ts_matches = re.findall(r'(\d+(?:\.\d+)?)\s*(?:MPa|GPa)', text, re.I)
    if ts_matches:
        metrics['tensile_strength_MPa'] = [float(m) for m in ts_matches]
    # Surface roughness (Ra)
    ra_matches = re.findall(r'Ra\s*=\s*(\d+(?:\.\d+)?)', text, re.I)
    if ra_matches:
        metrics['roughness_Ra'] = [float(m) for m in ra_matches]
    return metrics
...
# ============================================================================
# LLM‑GUIDED QUERY & ONTOLOGY EXPANSION (ADAPTED TO LAM)
# ============================================================================
# The following classes are adapted for LAM, keeping the same architecture.
...
# ============================================================================
# 1. QUERY ANALYSIS DATA STRUCTURES (LAM)
# ============================================================================
class LAMProblem(Enum):
    POROSITY_MITIGATION = "porosity_mitigation"
    RESIDUAL_STRESS_CONTROL = "residual_stress_control"
    MICROSTRUCTURE_TAILORING = "microstructure_tailoring"
...
@dataclass
class LAMProblemDefinition:
    problem_id: LAMProblem
    title: str
...
LAM_PROBLEM_DEFINITIONS: Dict[LAMProblem, LAMProblemDefinition] = {
    LAMProblem.POROSITY_MITIGATION: LAMProblemDefinition(
        problem_id=LAMProblem.POROSITY_MITIGATION,
        title="Porosity Mitigation",
        scientific_description="Reducing porosity (lack of fusion and keyhole pores) to improve mechanical properties and fatigue life.",
        root_cause="Insufficient energy input (lack of fusion) or excessive energy input (keyhole) causing pore formation.",
        key_concepts=["porosity", "lack_of_fusion", "keyhole", "energy_density", "laser_power", "scan_speed"],
        key_relationships=[("energy_density", "INFLUENCES", "porosity"),
                           ("laser_power", "INFLUENCES", "melt_pool"),
                           ("scan_speed", "INFLUENCES", "melt_pool")],
        solution_directions=["Optimise energy density", "Use beam shaping", "Apply hot isostatic pressing"],
        relevant_materials=["ti_6al_4v", "inconel_718", "aisi_316l", "alsi10mg"],
        relevant_phenomena=["lack_of_fusion", "keyhole", "melt_pool"],
        relevant_properties=["porosity", "fatigue_life", "tensile_strength"],
        example_queries=["What laser power and scan speed minimise porosity in LPBF of Inconel 718?",
                         "How does hatch spacing affect lack of fusion pores?"],
        visualization_focus=["porosity_vs_energy_density", "melt_pool_dimensions"]
    ),
    LAMProblem.RESIDUAL_STRESS_CONTROL: LAMProblemDefinition(
        problem_id=LAMProblem.RESIDUAL_STRESS_CONTROL,
        title="Residual Stress Control",
        scientific_description="Minimising residual stresses to prevent distortion, cracking, and premature failure.",
        root_cause="Large thermal gradients and rapid cooling during printing.",
        key_concepts=["residual_stress", "thermal_gradient", "preheat_temperature", "scan_strategy"],
        key_relationships=[("thermal_gradient", "CAUSES", "residual_stress"),
                           ("preheat_temperature", "INFLUENCES", "thermal_gradient"),
                           ("scan_strategy", "INFLUENCES", "thermal_gradient")],
        solution_directions=["Substrate preheating", "Optimised scan strategy", "Post‑process heat treatment"],
        relevant_materials=["ti_6al_4v", "inconel_718", "h13_tool_steel"],
        relevant_phenomena=["thermal_gradient", "solidification_cracking"],
        relevant_properties=["residual_stress", "fatigue_life"],
        example_queries=["How does preheating temperature affect residual stress in SLM Ti-6Al-4V?",
                         "What scan strategy minimises distortion?"],
        visualization_focus=["residual_stress_vs_preheat", "thermal_gradient_map"]
    ),
    LAMProblem.MICROSTRUCTURE_TAILORING: LAMProblemDefinition(
        problem_id=LAMProblem.MICROSTRUCTURE_TAILORING,
        title="Microstructure Tailoring",
        scientific_description="Controlling grain morphology (columnar vs equiaxed), texture, and precipitates to optimise mechanical properties.",
        root_cause="Cooling rate and thermal gradient dictate solidification mode (epitaxial growth vs nucleation).",
        key_concepts=["columnar_grains", "equiaxed_grains", "cooling_rate", "thermal_gradient", "cet"],
        key_relationships=[("cooling_rate", "INFLUENCES", "columnar_grains"),
                           ("cooling_rate", "INFLUENCES", "equiaxed_grains"),
                           ("thermal_gradient", "INFLUENCES", "cet")],
        solution_directions=["Control cooling rate via scan speed", "Add inoculants", "Use beam shaping"],
        relevant_materials=["ti_6al_4v", "inconel_718", "alsi10mg"],
        relevant_phenomena=["epitaxial_growth", "cet", "anisotropy"],
        relevant_properties=["tensile_strength", "fatigue_life"],
        example_queries=["How can I promote equiaxed grains in LPBF of Inconel 718?",
                         "What is the effect of scan strategy on columnar grain orientation?"],
        visualization_focus=["grain_structure_map", "texture_pole_figures"]
    ),
    LAMProblem.PROCESS_OPTIMIZATION: LAMProblemDefinition(
        problem_id=LAMProblem.PROCESS_OPTIMIZATION,
        title="Process Optimisation",
        scientific_description="Finding the optimal combination of process parameters (power, speed, hatch, layer) for a given material and geometry.",
        root_cause="Large parameter space with complex interactions affecting quality and productivity.",
        key_concepts=["laser_power", "scan_speed", "hatch_spacing", "layer_thickness", "energy_density"],
        key_relationships=[("energy_density", "INFLUENCES", "melt_pool"),
                           ("melt_pool", "INFLUENCES", "porosity")],
        solution_directions=["Design of experiments", "Machine learning optimisation", "Analytical modelling"],
        relevant_materials=["ti_6al_4v", "inconel_718", "aisi_316l", "alsi10mg"],
        relevant_phenomena=["melt_pool", "lack_of_fusion", "balling"],
        relevant_properties=["porosity", "surface_roughness", "hardness"],
        example_queries=["What is the optimal laser power for SLM of AlSi10Mg?",
                         "How does hatch spacing affect surface roughness?"],
        visualization_focus=["process_window_map", "property_vs_energy_density"]
    ),
    LAMProblem.DEFECT_DETECTION: LAMProblemDefinition(
        problem_id=LAMProblem.DEFECT_DETECTION,
        title="Defect Detection",
        scientific_description="Developing in‑situ and ex‑situ methods to detect and classify defects such as pores, cracks, and spatter.",
        root_cause="Real‑time monitoring is challenging; defects may not be visible post‑build.",
        key_concepts=["in_situ_monitoring", "xct", "thermal_imaging", "machine_learning"],
        key_relationships=[("in_situ_monitoring", "DETECTS", "porosity"),
                           ("xct", "DETECTS", "lack_of_fusion")],
        solution_directions=["In‑situ thermography", "X‑ray computed tomography", "Acoustic emission monitoring"],
        relevant_materials=["ti_6al_4v", "inconel_718", "aisi_316l"],
        relevant_phenomena=["spatter", "melt_pool_instability"],
        relevant_properties=["porosity", "surface_roughness"],
        example_queries=["What sensors are used for in‑situ defect detection in LPBF?",
                         "Can machine learning predict porosity from melt pool images?"],
        visualization_focus=["monitoring_signal_vs_defect", "confusion_matrix"]
    ),
    LAMProblem.MATERIAL_DEVELOPMENT: LAMProblemDefinition(
        problem_id=LAMProblem.MATERIAL_DEVELOPMENT,
        title="Material Development for LAM",
        scientific_description="Designing new alloys or composites specifically for additive manufacturing to exploit rapid solidification and complex thermal cycles.",
        root_cause="Traditional alloys may crack or have poor printability.",
        key_concepts=["material", "precipitates", "solidification_cracking", "printability"],
        key_relationships=[("solidification_cracking", "PREVENTS", "printability"),
                           ("precipitates", "INFLUENCES", "hardness")],
        solution_directions=["Alloy design with CALPHAD", "In‑situ alloying", "Nanoparticle additions"],
        relevant_materials=["ni_20zr", "ni_5al", "ni_5nb", "h13_tool_steel"],
        relevant_phenomena=["microstructure_evolution", "solidification_cracking"],
        relevant_properties=["tensile_strength", "hardness", "corrosion_resistance"],
        example_queries=["Which alloy compositions are printable by LPBF without cracking?",
                         "How do precipitates affect mechanical properties in LAM?"],
        visualization_focus=["printability_map", "phase_diagram"]
    ),
    LAMProblem.GENERAL: LAMProblemDefinition(
        problem_id=LAMProblem.GENERAL,
        title="General LAM Inquiry",
        scientific_description="General question about laser additive manufacturing.",
        root_cause="N/A",
        key_concepts=["lpbf", "slm", "ded"],
        key_relationships=[],
        solution_directions=[],
        relevant_materials=[],
        relevant_phenomena=[],
        relevant_properties=[],
        example_queries=["What are the key benefits of LPBF compared to casting?"],
        visualization_focus=["general_overview"]
    ),
    LAMProblem.MULTI_PROBLEM: LAMProblemDefinition(
        problem_id=LAMProblem.MULTI_PROBLEM,
        title="Multi‑Problem LAM Inquiry",
...
class QueryAnalysisResult:
    ...
    primary_problem: LAMProblem
    secondary_problems: List[LAMProblem]
...
class FallbackAnalyzer(LLMQueryAnalyzer):
    PROBLEM_KEYWORDS = {
        LAMProblem.POROSITY_MITIGATION: {"porosity", "pore", "lack of fusion", "keyhole", "density"},
        LAMProblem.RESIDUAL_STRESS_CONTROL: {"residual stress", "distortion", "cracking", "thermal stress"},
        LAMProblem.MICROSTRUCTURE_TAILORING: {"microstructure", "grain", "columnar", "equiaxed", "texture", "precipitate"},
        LAMProblem.PROCESS_OPTIMIZATION: {"parameter", "optimize", "power", "speed", "hatch", "layer"},
        LAMProblem.DEFECT_DETECTION: {"detect", "monitor", "in-situ", "xct", "thermography", "sensor"},
        LAMProblem.MATERIAL_DEVELOPMENT: {"alloy", "composition", "printability", "new material"},
    }
    ...
    def analyze_query(self, query: str, ontology: Any) -> QueryAnalysisResult:
        ...
        primary = max(problem_scores, key=problem_scores.get) if sum(problem_scores.values()) > 0 else LAMProblem.GENERAL
        ...
        inferred = []
        if primary != LAMProblem.GENERAL:
            pdef = LAM_PROBLEM_DEFINITIONS[primary]
        ...
        priorities = {}
        pdef = LAM_PROBLEM_DEFINITIONS.get(primary, LAM_PROBLEM_DEFINITIONS[LAMProblem.GENERAL])
...
# --- OpenAIQueryAnalyzer and LocalLLMQueryAnalyzer are identical to thermoelectric version, except they use LAMProblem definitions.
# We'll reuse them with minimal changes: change TEProblem to LAMProblem in type hints and use LAM_PROBLEM_DEFINITIONS.
...
class OpenAIQueryAnalyzer(LLMQueryAnalyzer):
    ...
    def analyze_query(self, query: str, ontology: Any) -> QueryAnalysisResult:
        ...
        system_prompt = """You are an expert in laser additive manufacturing. Analyze the user's query and return ONLY valid JSON with:
        1. "primary_problem": One of: porosity_mitigation, residual_stress_control, microstructure_tailoring, process_optimization, defect_detection, material_development, general, multi_problem
        ...
        7. "new_concepts": List of objects with "name" (snake_case), "type" (material/property/phenomenon/process/method/parameter/microstructure), "definition", "synonyms" (list)
        ...
        try:
            ...
            problem_map = {p.value: p for p in LAMProblem}
            primary = problem_map.get(parsed.get("primary_problem", "general"), LAMProblem.GENERAL)
            ...
            return QueryAnalysisResult(
                ...
                visualization_focus=LAM_PROBLEM_DEFINITIONS[primary].visualization_focus, reasoning_chain=parsed.get("reasoning_chain", ["LLM analysis completed"]), confidence=0.85
            )
        except Exception as e:
...
class LocalLLMQueryAnalyzer(LLMQueryAnalyzer):
    ...
    def analyze_query(self, query: str, ontology: Any) -> QueryAnalysisResult:
        if not self.is_available():
            return FallbackAnalyzer().analyze_query(query, ontology)
        prompt = (
            f"[INST] You are an expert in laser additive manufacturing. Analyze: '{query}'. "
...
# ============================================================================
# 3. DYNAMIC ONTOLOGY EXPANDER (unchanged logic, using LAM)
# ============================================================================
class DynamicOntologyExpander:
    ...
    def _create_bridge_concept(self, missing_concept: str, source_query: str, problem: LAMProblem) -> Optional[Dict]:
        bridge_name = f"query_bridge_{missing_concept.replace(' ', '_').lower()}"
        if bridge_name in self.ontology.concepts: return None
        pdef = LAM_PROBLEM_DEFINITIONS.get(problem, LAM_PROBLEM_DEFINITIONS[LAMProblem.GENERAL])
...
class QueryDrivenVisualizer:
    def __init__(self, ontology: Any):
        self.ontology = ontology
        self.type_colors = {"material": "#FF6B6B", "property": "#4ECDC4", "phenomenon": "#FFE66D", "method": "#95E1D3", "parameter": "#F38181", "process": "#AA96DA", "microstructure": "#E67E22", "model": "#FCBAD3", "general": "#A8D8EA"}
...
class GraphRAGAnswerGenerator:
    ...
    def generate_ground_response(self, query: str, analysis: QueryAnalysisResult, subgraph: nx.Graph, concept_abstract_map: Dict[str, List[int]], all_texts: Union[List[str], Dict[int, str]], max_docs_per_concept: int = 2) -> str:
        ...
        nl = chr(10)
        prompt = "You are an expert in laser additive manufacturing. Answer the user's query based *strictly* on the provided graph context and evidence snippets." + nl
        ...
        if evidence_snippets:
            ...
            prompt += "No direct text snippets found. Rely on your general knowledge of LAM but note the lack of specific retrieved context." + nl
        prompt += "Instructions:" + nl
        prompt += "1. Provide a direct, scientifically accurate answer (2-3 paragraphs)." + nl
        prompt += "2. Explicitly mention how the key concepts interact (e.g., causal chains like 'laser power influences melt pool geometry')." + nl
...
# ============================================================================
# 7. STREAMLIT UI INTEGRATORS (adapted to LAM)
# ============================================================================
def render_llm_query_panel(ontology: Any, expander: DynamicOntologyExpander, full_graph: nx.Graph) -> Optional[QueryAnalysisResult]:
    ...
    example_queries = [q for pdef in LAM_PROBLEM_DEFINITIONS.values() for q in pdef.example_queries[:1]]
    selected_example = st.sidebar.selectbox("Or select an example:", [""] + example_queries, key="example_query_select")
    query = st.sidebar.text_area("Your LAM question:", value=selected_example, height=100, key="llm_query_input", placeholder="e.g., How does laser power affect porosity in LPBF of Ti-6Al-4V?")
...
def render_llm_qa_tab(analysis_data: Dict, ontology: Any):
    ...
    st.markdown("Ask a specific scientific question about laser additive manufacturing. The system will dynamically expand the ontology, extract a relevant subgraph, and generate a grounded answer using retrieved literature snippets.")
    ...
    with col1: query = st.text_input("Enter your research question:", placeholder="e.g., How does scan speed affect residual stress in LPBF of Inconel 718?")
...
def render_microtransformer_kg_rag_tab(analysis_data: Dict, ontology: Any):
    ...
    process-structure-property links. It uses **Latent Mixture of Experts (l-MoE_acc)**
    ...
    # Quick query parsing for LAM
    QUERY_CONCEPT_MAP = [
        (r"\bpower\b.*\bporosity\b", "laser_power", "porosity"),
        (r"\bspeed\b.*\bporosity\b", "scan_speed", "porosity"),
        (r"\bhatch\b.*\bporosity\b", "hatch_spacing", "porosity"),
        (r"\bpreheat\b.*\bstress\b", "preheat_temperature", "residual_stress"),
        (r"\bstrategy\b.*\bstress\b", "scan_strategy", "residual_stress"),
        (r"\bcooling\b.*\bgrain\b", "cooling_rate", "columnar_grains"),
        (r"\bgrain\b.*\bproperty\b", "grain_size", "tensile_strength"),
        (r"\bporosity\b.*\bfatigue\b", "porosity", "fatigue_life"),
        (r"\broughness\b.*\bfatigue\b", "surface_roughness", "fatigue_life"),
        (r"\bhip\b.*\bporosity\b", "hot_isostatic_pressing", "porosity"),
        (r"\bheat\s+treat\b.*\bhardness\b", "heat_treatment", "hardness"),
    ]

    quick_query = st.text_input(
        "Or type a natural-language question:",
        value="How does laser power affect porosity?",
        key="mt_quick_query",
        placeholder="e.g., How does laser power affect porosity?",
    )
    ...
    if nlp_src and nlp_tgt:
        ...
        default_src_idx = find_option_index("laser_power")
        default_tgt_idx = find_option_index("porosity")
    ...
    if not run:
        ...
        per_token_df = pd.DataFrame(routing_np, index=token_labels, columns=LAM_EXPERT_LABELS)
        fig_heat = px.imshow(
            per_token_df.T,
        ...
        df_experts = pd.DataFrame({
            "Expert Domain": LAM_EXPERT_LABELS,
        ...
        interpretation_map = {
            "Laser Power Effects": "The model recognizes that laser power directly influences melt pool temperature and size.",
            "Scan Speed": "Scan speed affects exposure time, heat input, and cooling rate.",
            "Energy Density": "The combined parameter (power/speed/hatch/layer) governs defect formation.",
            "Melt Pool Geometry": "Shape and size of the melt pool dictate solidification and defects.",
            "Keyhole Stability": "High energy density leads to keyhole formation, causing spherical porosity.",
            "Lack of Fusion": "Insufficient energy causes inter-track/inter-layer gaps.",
            "Porosity Formation": "Central defect category linking process and properties.",
            "Residual Stress": "Thermal gradients and cooling induce stresses that can cause cracking.",
            "Solidification Cracking": "Occurs under high constraint and low ductility.",
            "Thermal Gradients": "Steep gradients lead to high residual stress and columnar growth.",
            "Cooling Rate": "Dictates grain size and phase formation.",
            "Columnar Grains": "Epitaxial growth along build direction; cause of anisotropy.",
            "Equiaxed Grains": "Desired for isotropy; promoted by high undercooling or inoculants.",
            "Tensile Strength": "Affected by porosity, grain size, and precipitates.",
            "Hardness": "Correlates with grain refinement and precipitate density.",
            "Fatigue Life": "Highly sensitive to surface roughness and internal porosity.",
            "Surface Roughness": "As‑built roughness acts as stress raiser for fatigue.",
            "In-situ Monitoring": "Enables real‑time defect detection and process control.",
            "XCT Defect Detection": "Non‑destructive 3D characterization of pores and cracks.",
        }
...
# ============================================================================
# SIDEBAR (adapted to LAM)
# ============================================================================
def render_sidebar() -> None:
    with st.sidebar:
        st.header("⚙️ Configuration v1.0 (Laser Additive Manufacturing)")
        st.subheader("🎨 Theme")
        ...
        st.subheader("⚡ LAM Focus Areas")
        st.markdown("- **Materials:** Ti-6Al-4V, Inconel 718, 316L, AlSi10Mg, Hastelloy X, CuCrZr, M50NiL, Ti-5553, Inconel 625, CM247LC, Co-Cr-Mo, H13 tool steel, maraging steel")
        st.markdown("- **Processes:** LPBF, SLM, DED, EBM, WAAM, laser cladding, HIP, heat treatment")
        st.markdown("- **Properties:** Porosity, residual stress, hardness, tensile strength, fatigue life, surface roughness")
        st.markdown("- **Phenomena:** Melt pool, keyhole, lack of fusion, spatter, balling, solidification cracking, thermal gradients, epitaxial growth, CET")
        st.markdown("- **Microstructure:** Columnar grains, equiaxed grains, cellular dendrites, precipitates")
        st.markdown("- **Parameters:** Laser power, scan speed, hatch spacing, layer thickness, energy density, preheating temperature, scan strategy")
        st.markdown("- **Methods:** XCT, SEM, EBSD, XRD, TEM, thermal imaging, in-situ monitoring, FEA, machine learning")
        st.subheader("🧠 NLP Reasoning Options")
        st.session_state['use_ontology'] = st.checkbox(
            "Use ontology-based resolution", value=True,
            help="Maps synonyms like 'LPBF' to canonical concepts",
        )
        ...
        st.session_state['use_relationship_extraction'] = st.checkbox(
            ...
            help="Identifies causal links between processing parameters and defects",
        )
        st.session_state['use_inference'] = st.checkbox(
            "Enable reasoning-based edge inference", value=True,
            help="Infers process-structure-property chains even when not co-occurring",
        )
...
def main() -> None:
    st.title(
        "🔬 Laser Additive Manufacturing Concept Graph v1.0"
    )
    st.caption(
        "Multi-level reasoning concept graph for laser additive manufacturing | "
        "Focus: Process–Structure–Property relationships, defect mitigation, "
...
1. Your documents don't contain the exact terminology the regex patterns expect (e.g., 'laser power' vs 'power')
        ...
        with tabs[tab_idx]:
            ...
            if top_scores.empty:
                ...
                st.download_button(
                    ...
                    file_name="lam_research_directions.csv", mime="text/csv",
                )
        ...
        with tabs[tab_idx]:
            ...
            if st.button("Generate Publication Figure"):
                ...
                if pub_bytes:
                    st.download_button(
                        ...
                        data=pub_bytes,
                        file_name="lam_graph_publication.png",
                        mime="image/png",
                    )
            st.markdown("---")
            ...
            if st.button("Generate Markdown Report"):
                ...
                st.download_button(
                    ...
                    file_name="lam_analysis_report.md",
                    mime="text/markdown",
                )
            ...
            st.download_button(
                ...
                data=csv_concepts,
                file_name="lam_concepts_enhanced.csv", mime="text/csv",
            )
